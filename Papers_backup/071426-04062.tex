...
By combining ROI-based preprocessing, HOG feature extraction, and a Linear Support Vector Machine, we established a lightweight yet effective pipeline for traffic sign recognition on the GTSRB dataset. The 324-dimensional feature classifier successfully handles 43 sign categories with a 92.36\% validation accuracy, proving particularly robust on well-represented classes like "Priority road" and "Yield".
